...
//     length 2 containing objects (representing Adam and Eve). The first object
//     in the array should be an instance of the class Man. The second should be
//     an instance of the class Woman. Both objects have to be subclasses of Human.
